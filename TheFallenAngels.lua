...
do
	...
	do --// credits to finobe wtv im way too lazy
		...
		local window = ui.tabs["settings"]:Section({Name = "Window", Side = "Right", Size = 170});
		local tools = ui.tabs["settings"]:Section({Name = "Tool", Side = "Right", Size = 160});
		...
		MakeTool = function(ToolKeybind, ToolInstanceName)
		    ...
		    ToolInstanceName.Activated:Connect(function()
		        game:GetService("VirtualInputManager"):SendKeyEvent(true, ToolKeybind, false, game)
		    end)
		...
		MakeButton = function(ButtonKeybind, ButtInstanceName)
		    Instance.new('ScreenGui', game:GetService("RunService"):IsStudio() and game.Players.LocalPlayer.PlayerGui or game.CoreGui).DisplayOrder = 100
		    local Button = Instance.new("TextButton", game:GetService("RunService"):IsStudio() and game.Players.LocalPlayer.PlayerGui or game.CoreGui)
		...
		tools:Textbox({Flag = "Button Keybind", Placeholder = "Button Keybind"});
